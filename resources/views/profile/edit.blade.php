...
@section('content')
    ...
    {{-- À ajouter au début de la vue profile/edit.blade.php --}}
    ...
    @if(session('error'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            @if(session('required_fields'))
                <hr>
                <p class="mb-2"><strong>Champs manquants :</strong></p>
                <ul class="mb-0">
                    @foreach(session('required_fields') as $field => $label)
                        <li>{{ $label }}</li>
                    @endforeach
                </ul>
                <hr>
                <p class="mb-0">
                    ...
                    Veuillez remplir ces informations pour pouvoir créer une annonce.
                </p>
            @endif
