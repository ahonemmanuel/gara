            ...
            `;
                ...
                function calculateEstimation() {
                    ...
                    if (marque && annee && kilometrage && etat) {
                        ...
                        const estimation = Math.round(basePrice / 50) * 50; // Arrondir aux 50€
                        document.getElementById('estimation-value').textContent = estimation + '€';
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <strong class="text-primary">
                                            {{ $demande->prix_souhaite ? number_format($demande->prix_souhaite, 0, ',', ' ') . '€' : 'À négocier' }}
                                        </strong>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if($demande->prix_souhaite)
                                                    <small class="text-muted">Prix souhaité: {{ number_format($demande->prix_souhaite, 0, ',', ' ') }}€</small>
                                                @endif
                                            </div>
                                                                        ...
                                                                        <div class="border-bottom p-3">
                                                                            <div class="row align-items-center">
                                                                                ...
                                                                                <div class="col-md-2 text-end">
                                                                                    <strong>{{ number_format($item->getSousTotal(), 2, ',', ' ') }}€</strong>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    @endforeach
                                                            ...
                                                            <div class="card sticky-top">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="d-flex justify-content-between mb-2">
                                                                        ...
                                                                        <span>{{ number_format($panier->getTotal() * 0.18, 2, ',', ' ') }}€</span>
                                                                    </div>
                                                                    <hr>
                                                                    <div class="d-flex justify-content-between mb-3">
                                                                        <strong>Total à payer</strong>
                                                                        <strong class="text-primary fs-5">{{ number_format($panier->getTotal(), 2, ',', ' ') }}€</strong>
                                                                    </div>
                                                            ...
                                                            @foreach($commande->items as $item)
                                                                <div class="border-bottom p-3">
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="col-md-2 text-center">
                                                                            <span class="fs-6">{{ number_format($item->prix_unitaire, 2, ',', ' ') }}€</span>
                                                                        </div>
            ...
            @forelse($piecesPopulaires as $piece)
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                        ...
                        <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                <strong class="text-primary">{{ number_format($piece->prix, 0, ',', ' ') }}€</strong>
        ...
        <div class="row">
                            ...
                            <div class="border-bottom p-3" id="item-{{ $item->id }}">
                                            ...
                                            <div class="bg-light rounded d-flex align-items-center justify-content-center" style="height: 80px;">
                                                ...
                                                <div class="col-md-2 text-center">
                                                <strong class="text-primary">{{ number_format($item->piece->prix, 2, ',', ' ') }}€</strong>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <div class="col-md-1 text-center">
                                                <strong class="item-total">{{ number_format($item->getSousTotal(), 2, ',', ' ') }}€</strong>
                                                </div>
                                                <div class="col-md-1 text-center">
                                                ...
                                                <div class="d-flex justify-content-between mb-2">
                                                <span>Sous-total ({{ $panier->items->count() }} articles)</span>
                                                <span id="subtotal">{{ number_format($panier->getTotal(), 2, ',', ' ') }}€</span>
                                                </div>
                                                <div class="d-flex justify-content-between mb-2">
                                                <span>Livraison</span>
                                                ...
                                                <div class="d-flex justify-content-between mb-3">
                                                <strong>Total</strong>
                                                <strong class="text-primary" id="total">{{ number_format($panier->getTotal(), 2, ',', ' ') }}€</strong>
                                                </div>
                        ...
                        @foreach($suggestions as $piece)
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted">{{ $piece->prix }}€</small>
                                                </div>
