                ...
                <form action="{{ route('client.vente-epaves.creer') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label">Prix souhaité (€)</label>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p><strong>Prix souhaité:</strong>
                                {{ $vente->prix_souhaite ? number_format($vente->prix_souhaite, 2) . ' €' : 'À estimer' }}
                            </p>
                            ...
                            @if($vente->prix_propose)
                                <div class="alert alert-info">
                                    <strong>Prix proposé:</strong> {{ number_format($vente->prix_propose, 2) }} €
                            ...
                            <div class="modal-body">
                                ...
                                @if($vente->notes_evaluation)
                                    <div class="alert alert-info mt-3">
                                        ...
                                        @if($vente->prix_propose)
                                            <br><strong>Prix proposé:</strong> {{ number_format($vente->prix_propose, 2) }} €
                                        @endif
                                    </div>
                                @endif
                            </div>
