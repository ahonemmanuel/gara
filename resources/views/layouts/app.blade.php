            ...
            <ul class="nav flex-column">
                ...
                @if(auth()->user()->role->value == 'admin' || auth()->user()->role->value == 'casse') @endif
                    ...
                    @if(auth()->user()->role->value == 'casse')
                        ...
                        {{-- Stocks (Pièces + Véhicules) --}}
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('gestion.stocks') ? 'active' : '' }}"
               ...
               {{--         <li class="nav-item">
                    ...
                    @if(auth()->user()->role->value == 'client')
                        ...
                        {{-- Mes annonces --}}
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('client.annonces') || request()->routeIs('stocks.index') ? 'active' : '' }}"
