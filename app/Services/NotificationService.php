...
class NotificationService
{
    ...
    public function nouvelleOffre(User $proprietaire, OffreEpave $offre)
    {
        return Notification::create([
            ...
            'message' => "Vous avez reçu une offre de {$offre->prix_offert}€ pour votre {$offre->demandeEpave->marque} {$offre->demandeEpave->modele}.",
            'data' => [
                'offre_id' => $offre->id,
    ...
    public function offreAcceptee(User $casse, OffreEpave $offre)
    {
        return Notification::create([
            ...
            'message' => "Votre offre de {$offre->prix_offert}€ pour le {$offre->demandeEpave->marque} {$offre->demandeEpave->modele} a été acceptée.",
            'data' => [
                'offre_id' => $offre->id,
                'prix_offert' => $offre->prix_offert,
